...
const STEPS = [
  {
    ...
    description:
      "CivicOS uses AI to generate clear, accessible learning materials tailored to your issue and community.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Host structured dialogues using Polis for large-group opinion mapping and facilitated sessions via Jitsi \u2014 surfacing common ground, not just the loudest voices.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-7 w-7">
  ...
  },
  {
    ...
    description:
      "Talk to the City synthesizes qualitative input with AI, visualizing emerging patterns and identifying proposals that reach 70%+ support across divides.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-7 w-7">
  ...
  },
  {
    ...
    description:
      "CivicOS's federated data ontology lets outputs be read at local, regional, and cross-state levels simultaneously \u2014 connecting school boards, city councils, and state legislatures without centralized control.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-7 w-7">
      ...
      <div className="mx-auto max-w-6xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            CivicOS orchestrates the full workflow&nbsp;&mdash; from zero to
            meaningful public conversation, fast.
          </p>
        </div>
